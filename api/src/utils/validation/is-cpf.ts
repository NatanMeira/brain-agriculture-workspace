import { generateValidatorDecorator } from './generate-validator-decorator';

export const IsCPF = generateValidatorDecorator(
  validateCpf,
  'IsCPF',
  'O valor informado ($value) para o campo $property precisa ser um CPF válido (Ex: 55555555555)',
);
